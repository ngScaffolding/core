...
export class OAuthService extends BaseStateService<AuthenticationState> {
    ...
    constructor(
        ...
        appSettingsService.selectByName(AppSettings.authOAuthSettings).subscribe(settingValue => {
            if (settingValue) {
